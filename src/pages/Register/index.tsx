      ...
      <div className="flex py-[16px] px-[20px] gap-[80px]">
        ...
        <div className="w-[758px] h-[40vw] justify-center gap-5 items-center flex flex-col">
          ...
          <form
            ...
            className="flex flex-wrap justify-between gap-2 w-[758px] h-[124px]"
          >
            <Input
              type="text"
              placeholder="Nome"
        ...
        <div>
          <p className="text-red fixed right-[442px] bottom-[467px]">
            {errors.email?.message}
          </p>
          <p className="text-red fixed right-[290px] bottom-[400px]">
